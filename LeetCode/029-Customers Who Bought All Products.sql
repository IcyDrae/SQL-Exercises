...
SELECT
    [CustomerProductsAmount].[customer_id]
FROM
    [CustomerProductsAmount] AS [CustomerProductsAmount]
INNER JOIN [ProductsAmount] AS [ProductsAmount] ON
    [CustomerProductsAmount].[amount] = [ProductsAmount].[amount];
