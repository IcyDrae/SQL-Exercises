...
-- Solution
DECLARE @DateBeginning DATETIME = DATEADD(DAY, -30, '2019-07-27');
DECLARE @DateEnd DATETIME = CAST('2019-07-27' AS DATETIME);
...
FROM
    [dbo].[Activity]
WHERE
    ([activity_date] > @DateBeginning AND [activity_date] <= @DateEnd)
