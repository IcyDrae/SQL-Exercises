...
where turn=1 denotes the first person to board and turn=n denotes the
...
the bus without exceeding the weight limit. The test cases are generated
...
FROM [Weight]
WHERE [Weight].[total_weight] <= 1000
ORDER BY [turn] DESC;
