...
Customer with id = 54 visited the mall three times. During 2 visits
they did not make any transactions, and during one visit they made 3 transactions.
...
FROM
    [dbo].[Transactions] AS [Transactions]
RIGHT JOIN [dbo].[Visits] AS [Visits] ON
