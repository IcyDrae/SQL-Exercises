...
their numbers of commits and contributors and also a random
...
SELECT
  SUBSTR(repositories.project, 1, repositories.commits) AS "project",
  SUBSTR(repositories.address,
         LENGTH(repositories.address) - (repositories.contributors - 1),
         repositories.contributors) AS "address"
FROM
  repositories;
